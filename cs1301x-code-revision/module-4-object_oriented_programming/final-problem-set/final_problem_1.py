...
def to_dictionaries(nation_list):
  ...
  for nation_inst in nation_list:
      dict_details = {}
      dict_details["long_name"] = nation_inst.long_name
      dict_details["iso_code"] = nation_inst.iso_code
      dict_details["iso_short"] = nation_inst.iso_short
      dict_details["iso_long"] = nation_inst.iso_long
      dict_details["capital"] = nation_inst.capital
      dict_nation[nation_inst.short_name] = dict_details
  return dict_nation
